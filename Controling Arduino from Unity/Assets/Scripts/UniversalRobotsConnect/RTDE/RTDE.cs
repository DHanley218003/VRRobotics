...
namespace UniversalRobotsConnect
{
    ...
    public class RTDE
    {
        ...
        private void GetRTDEConfigFromFile(string xmlKey, List<KeyValuePair<string, string>> rtdeConfiguration)
        {
            ...
            XmlReader xmlReader = XmlReader.Create(@"C:\Users\a0021\Desktop\vrrobotics-clementlb\Controling Arduino from Unity\Assets\Scripts\UniversalRobotsConnect\bin\Debug\Resources\rtde_configuration.xml");
